...
```shell
curl "https://analytics.getsocial.io/api/channels/facebook/stories?from=2018-01-01&to=2018-01-31&sort_by=shares&limit=2" \
  -H "Authorization: abcdef0123abcdef0123"
```
...
`GET https://analytics.getsocial.io/api/channels/<channel_id>/stories`
